...
- [[Pattern]] - document - .agents/skills/caveman-compress/SKILL.md
- [[Preserve EXACTLY (never modify)]] - document - .agents/skills/caveman-compress/SKILL.md
- [[Preserve Structure]] - document - .agents/skills/caveman-compress/SKILL.md
...
```dataview
TABLE source_file, type FROM #community/Caveman_Compress
SORT file.name ASC
```
