...
- [[Scope]] - document - specs/04-supabase-scores-foundation.md

## Live Query (requires Dataview plugin)

```dataview
TABLE source_file, type FROM #community/SPEC_04__Supabase_foundation_y_persistencia_de_puntuaciones
SORT file.name ASC
```
