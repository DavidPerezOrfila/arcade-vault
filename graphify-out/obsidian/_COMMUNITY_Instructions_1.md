...
- [[Instructions_1]] - document - resources/started-games/04-arkanoid/.agents/skills/spec-impl/SKILL.md
...
- [[SKILL_12]] - document - resources/started-games/04-arkanoid/.agents/skills/spec-impl/SKILL.md
...
```dataview
TABLE source_file, type FROM #community/Instructions
SORT file.name ASC
```
