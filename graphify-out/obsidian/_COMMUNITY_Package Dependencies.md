...
- [[ecc-universal_1]] - concept - package.json
- [[format]] - code - package.json
- [[formatcheck]] - code - package.json
- [[graphifyobsidian]] - code - package.json
- [[graphifyupdate]] - code - package.json
...
- [[react_1]] - concept - package.json
- [[react-dom]] - code - package.json
- [[react-dom_1]] - concept - package.json
- [[resend]] - code - package.json
- [[resend_1]] - concept - package.json
- [[scripts]] - code - package.json
- [[start]] - code - package.json
- [[teste2e]] - code - package.json
- [[version]] - code - package.json
- [[zod]] - code - package.json
- [[zod_1]] - concept - package.json

## Live Query (requires Dataview plugin)

```dataview
TABLE source_file, type FROM #community/Package_Dependencies
SORT file.name ASC
```

## Connections to other communities
- 1 edge to [[_COMMUNITY_Dev Tooling]]

## Top bridge nodes
- [[package.json]] - degree 7, connects to 1 community