# Graph Report - 05-arcade-vault  (2026-07-18)

## Corpus Check
- 114 files · ~74,177 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 708 nodes · 772 edges · 76 communities (67 shown, 9 thin omitted)
...
Cohesion: 0.06
Nodes (32): @dietrichgebert/ponytail, ecc-universal, next, dependencies, @dietrichgebert/ponytail, ecc-universal, next, react (+24 more)
...
## Knowledge Gaps
- **377 isolated node(s):** `HighlightIconKind`, `HighlightIconProps`, `initialState`, `HIGHLIGHTS`, `ContactFormData` (+372 more)
