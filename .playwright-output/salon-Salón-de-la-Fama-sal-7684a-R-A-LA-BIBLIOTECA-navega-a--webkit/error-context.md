...
Call log:
  - waiting for locator('a.btn.lg').filter({ hasText: 'VOLVER A LA BIBLIOTECA' })
    - locator resolved to <a href="/" class="btn lg">VOLVER A LA BIBLIOTECA</a>
...
- generic [active] [ref=e1]:
  - button "Open Next.js Dev Tools" [ref=e7] [cursor=pointer]:
    - img [ref=e8]
  - 'heading "Application error: a client-side exception has occurred while loading localhost (see the browser console for more information)." [level=2] [ref=e15]'
```
