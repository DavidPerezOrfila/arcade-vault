...
1. Owner/miembro comenta `/oc` en el issue
...
- Crear issue de prueba, comentar `/oc`, verificar que: el job de opencode corre, crea PR vinculado, el job de CI marca el PR con checks, el merge cierra el issue
