...
insert into public.games (id, title, short, long, cat, cover, color, best, plays) values
  ...
  ('asteroids', 'ASTEROIDS', 'Pulveriza asteroides en gravedad cero.', 'Tu nave triangular flota en vacío absoluto. Dispara y rota para dividir rocas en fragmentos cada vez más pequeños. Cuidado con los OVNIs en el horizonte.', 'SHOOTER', 'cover-asteroids', 'yellow', 41200, '15.6K'),
