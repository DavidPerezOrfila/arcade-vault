...
Estos tres siguen la receta de 8 archivos de la skill `integrate-arcade-game`
...
esté entre los implementados (`asteroids`, `caida`, `serpentina`) antes de
ofrecer partida real.

### BLOQUE BUSTER — `bloque-buster`

- **Refs motor vanilla disponible:** `resources/started-games/04-arkanoid/`
- **Categoría:** ARCADE · **Color:** cyan

Arkanoid rebautizado. Nave-paleta rebota un núcleo de plasma para pulverizar
muros de bloques. La grilla se reorganiza cada nivel. Motor disponible en
`resources/started-games/04-arkanoid/` pero aún no portado.
...
- **Leaderboard:** los tres juegos implementados delegan submit/get a
...
- **Loop de motor:** los tres juegos implementados usan `setTimeout`
