...
- [ ] bloque-buster — ARCADE / cyan — suggested 2026-08-12 — vanilla ref available
- [ ] invasores — SHOOTER / green — suggested 2026-08-12 — no vanilla ref
- [ ] gloton — ARCADE / yellow — suggested 2026-08-12 — no vanilla ref, high complexity
- [ ] ranaria — ARCADE / green — suggested 2026-08-12 — no vanilla ref
- [ ] duelo-pixel — VERSUS / cyan — suggested 2026-08-12 — no vanilla ref, only VERSUS title

## New proposals (Pool B)
<!-- agent appends retro titles here when Pool A is exhausted -->
